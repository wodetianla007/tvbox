function init(ext) {
    ...
    // ✅ 直接内嵌 JSON 内容（从 20251201.json 复制过来）
    return {
        "sites": [
     {
    "spider": "./spider.jar",
    ...
    "sites": [
        ...
        },
        {
            ...
            "changeable": 1,
            "api": "csp_AppYsV2",
            "ext": "https://v.catcs.cc/api.php/v1.vod"
        },
        {
            "key": "火猫",
            "name": "没有｜内容",
        ...
        },
        {
            ...
            "api": "csp_AppQi",
            "ext": {
                "site": "https://guwozj-1319364746.cos.ap-guangzhou.myqcloud.com/gw.txt",
        ...
        },
        {
            ...
            "api": "csp_AppQi",
            "ext": {
                "site": "https://staraugust123456.oss-cn-hangzhou.aliyuncs.com/2.txt",
        ...
        },
        {
            ...
            "api": "csp_AppGet",
            "ext": {
                "url": "http://43.154.4.75",
                "dataKey": "HDk-7CnlK8SQUGLg",
                "dataIv": "HDk-7CnlK8SQUGLg"
            }
        },
        {
            "key": "魔方",
            ...
            "api": "csp_AppGet",
            "ext": {
                "url": "http://app.ybn-ooo.top",
                "dataKey": "vcfgytu7654rtyui",
                "dataIv": "vcfgytu7654rtyui"
            }
        },
        {
            "key": "柒月",
            ...
            "ext": {
                "url": "https://www.ys.mk",
                "dataKey": "mayday6770249ash",
                "dataIv": "mayday6770249ash"
            }
        },
        {
            "key": "小猫",
        ...
        },
        {
            ...
            "api": "csp_AppGet",
            "ext": {
                "site": "https://qiliniao-1331306839.cos.ap-chengdu.myqcloud.com/jg.txt",
        ...
        },
        {
            ...
            "ext": {
                ...
                "dataKey": "2c4h36abd96se10u",
                "dataIv": "2c4h36abd96se10u"
            }
        },
        {
            "key": "番薯动漫",
